  ...
  return (
    <div className='pb h-[100vh] flex flex-col justify-center items-center gap-[10px]'>
      ...
      <div className=' flex flex-col justify-center items-center gap-[10px] p-[20px]'>
        <input type="text" name='FullName' placeholder='Enter Full Name:' ref={userName}  required className='border-green-400 border-2  rounded-[5px] p-[6px] w-[68vw] sm:w-[35vw]' />
        ...
        <button className='p-[5px]  text-green-600 font-semibold rounded-xl border-2 border-green-500 hover:bg-green-500 hover:text-white w-[28vw] sm:w-[10vw]' onClick={()=>{handleOnclick()}}>Submit </button>
      </div>
    </div>
  )
}
